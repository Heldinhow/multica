...
type TaskContextForEnv struct {
	...
	WorkflowRole      string              // planner, coder, reviewer, tester (empty for non-workflow)
	WorkflowRunMode   string              // planning_only, planning_plus_execution (empty for non-workflow)
	WorkflowPhase     string              // planning, plan_review, execution, etc.
}
